                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(des)){
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(ForgetPwdActivity.this,"提交错误信息", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
            ...
            switch (v.getId()){
                case R.id.btn_getCode:
                    ...
                    if (isPhone && !isEmail){
                        ...
                        Toast.makeText(ForgetPwdActivity.this, "手机或邮箱账号有误",Toast.LENGTH_SHORT).show();
                ...
                case R.id.btn_submit:
                    if (firstPwd.getText().toString().equals(secondPwd.getText().toString()) ){
                        ...
                        Toast.makeText(ForgetPwdActivity.this,"两次输入密码不一致！",Toast.LENGTH_SHORT).show();
